			...
			<div class="col-md-6" style="margin:0px auto;float:none;" ng-app='myApp' ng-controller='myCtrl'>
				...
				<div class="panel">
					<div class="panel-body">
						...
						<input type="text" class="form-control" placeholder="region name" ng-model="regionName">
						<br>
						<label>Region Description</label>
						<textarea class="form-control" placeholder="region description" rows="4" ng-model="regionDescription"></textarea>
						<br>
						<div>
